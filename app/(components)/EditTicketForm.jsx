...
const TicketForm = ({ticket}) => {
    ...
    const startingTicketData = {
        title: "", description: "", priority: 1, progress: 0, status: "not started", category: "Hardware Problem",
    };
    ...
    return (<div className="flex justify-center">
            <form className="flex flex-col gap-3 w-1/2" method="post" onSubmit={handleSubmit}>
                <h3>{EditMod ? "Update your Ticket" : "Create Ticket"}</h3>
                <label>Title</label>
                <input type="text"
                       id="title"
                       name="title"
                ...
                <div>
                    ...
                    <label>5</label>
                    <input type="radio" id="priority-6" name="priority" onChange={handleChange} value={6} checked={formData.priority == 6}/>
                    <label>6</label>
                </div>
                ...
                <input type="submit" className="btn" value={EditMod ? "Update Ticket" : "Create Ticket"}/>
            </form>
        </div>);
};
